...
func (r *RunnerCluster) Default(_ context.Context, obj *RunnerCluster) error {
	runnerclusterlog.Info("defaulting RunnerCluster", "name", obj.Name)

	if obj.Spec.RunnerNamespace == "" {
		obj.Spec.RunnerNamespace = defaultRunnerNamespace
	}
...
func (r *RunnerCluster) ValidateCreate(_ context.Context, obj *RunnerCluster) (admission.Warnings, error) {
...
func (r *RunnerCluster) ValidateUpdate(_ context.Context, oldObj, newObj *RunnerCluster) (admission.Warnings, error) {
	...
	if err := appendStatusErrorCauses(&allErrs, newObj.validateRunnerCluster()); err != nil {
		return nil, err
	}
...
func (r *RunnerCluster) ValidateDelete(_ context.Context, obj *RunnerCluster) (admission.Warnings, error) {
